...
#
# Created: Tue Apr 21 22:51:53 2015
...
class Ui_Tiss(object):
    def setupUi(self, Tiss):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 732, 227))
        ...
        self.gridLayout.addWidget(self.spbCircleSeg, 3, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblCircleSeg, 3, 6, 1, 3)
        ...
        self.chkPolar = QtGui.QCheckBox(self.layoutWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.chkPolar.setFont(font)
        self.chkPolar.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.chkPolar.setObjectName(_fromUtf8("chkPolar"))
        self.gridLayout.addWidget(self.chkPolar, 4, 8, 1, 2)
    ...
    def retranslateUi(self, Tiss):
        ...
        self.label_11.setText(_translate("Tiss", "in km: ", None))
        self.label_9.setText(_translate("Tiss", "in degree: ", None))
        self.label_8.setText(_translate("Tiss", "Radius", None))
        self.chkPolar.setText(_translate("Tiss", "Circles on poles", None))
