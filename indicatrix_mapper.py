...
from indicatrix_mapper_dialog import tissDialog
import os.path
...
class tiss:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Indicatrix mapper')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'tiss')
        self.toolbar.setObjectName(u'tiss')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('tiss', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Indicatrix mapper'),
            callback=self.run,
